...
\mdtheorem[style=semanticbox,startcode=\BoxIcon{proof}]{alternativeproof}{Alternativer Beweis}[chapter]
...
\mdtheorem[style=semanticbox,startcode=]{explanation}{Erklärung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{proof}]{proofsummary}{Beweiszusammenfassung}[chapter]
...
\mdtheorem[style=semanticbox,startcode=]{answer}{Antwort}[chapter]
\mdtheorem[style=semanticbox,startcode=]{induction}{Induktionsbeweis}[chapter]
