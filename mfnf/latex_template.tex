...
\usepackage[paperwidth=161mm, paperheight=241mm, top=20.5mm, bottom=32.6mm, outer=24.7mm, inner=16.5mm]{geometry}
...
\addtocontents{lof}{{Alle Abbildungen sind auffindbar auf \textbf{Wikimedia Commons}, einer Sammlung von frei verwendbaren Mediendateien, zu der jeder beitragen kann.\\
Wenn du eine Abbildung weiterverwenden willst, findest du unter \textbf{\url{https://commons.wikimedia.org/wiki/File:<BILDNAME>}} mehr Informationen.
}\\}
\addtocontents{lof}{}
...
\newcommand{\BluePageBG}{\colorbox{sblau!35}{\parbox[t][\paperheight][l]{\paperwidth}{${}$}}}
