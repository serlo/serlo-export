...
\addtokomafont{title}{\changefontsizes{44pt}}
\addtokomafont{part}{\changefontsizes{44pt}}
...
\mdtheorem[style=semanticbox,startcode=\BoxIcon{definition}]{definition}{Definition}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{exercise}]{exercise}{Übung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{solution}]{solution}{Lösung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{alternativeproof}]{alternativeproof}{Alternativer Beweis}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{warning}]{warning}{Warnung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{hint}]{hint}{Hinweis}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{explanation}]{explanation}{Erklärung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{proofsummary}]{proofsummary}{Beweiszusammenfassung}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{solutionprocess}]{solutionprocess}{Lösungsweg}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{example}]{example}{Beispiel}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{answer}]{answer}{Antwort}[chapter]
\mdtheorem[style=semanticbox,startcode=\BoxIcon{induction}]{induction}{Induktionsbeweis}[chapter]

\makeatletter
\let\proof\@undefined
\let\endproof\@undefined
\makeatother
\mdtheorem[style=semanticbox,startinnercode=\BoxIcon{proof}]{proof}{Beweis}[chapter]
